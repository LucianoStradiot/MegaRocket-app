...
class SignUpPage {
  ...
  get errorEmail() {
    return $('[data-testid="email-sign-up"] + p');
  }
  get errorDni() {
    return $('[data-testid="dni-sign-up"] + p');
  }
  get errorPhone() {
    return $('[data-testid="phone-sign-up"] + p');
  }
  get errorCity() {
    return $('[data-testid="city-sign-up"] + p');
  }
  get errorZip() {
    return $('[data-testid="postal-code-sign-up"] + p');
  }
  get errorDate() {
    return $('[data-testid="sign-up-form"] section input + p');
  }
  get errorMembership() {
    return $('[data-testid="sign-up-form"] select + p');
  }
  get errorPassword() {
